# DW Nico's Weg A1 - Chapter 2 Contact Details (Speaking Workbook)

Compact English + Bangla notes aligned with the official DW Chapter 2 lessons and scenes.

Verified lesson titles from DW:
...
Source: https://learngerman.dw.com/en/nicos-weg/c-36519789

## How to study this chapter

- Say all numbers aloud, not only in your head.
- Practice digit by digit first, then in short groups.
- For addresses and phone numbers, point with your finger as you speak.
- Do the drills fast, because contact details are usually spoken fast in real life.

## Workbook routine

1. Count slowly.
2. Count again faster.
3. Say the German after seeing only the number or English.
4. Do the role-play like a phone call or office conversation.

## Number pattern card

| Pattern | Example | Bangla note |
|---|---|---|
| 13-19 | `dreizehn`, `vierzehn` | number + `zehn` |
...
DW focus: counting to 100 and using numbers in context.  
...
Quick note: `31` is `einunddreißig`, literally `one-and-thirty`.  
দ্রুত নোট: `31` = `einunddreißig`, আক্ষরিকভাবে `এক-এবং-তিরিশ`।
...
1. `I am 20 years old.` -> `Ich bin zwanzig Jahre alt.`
2. `0800` -> `null acht hundert`
3. `My number is ...` -> `Meine Nummer ist ...`
...
2. `Is that a two or a seven?` -> `Ist das eine Zwei oder eine Sieben?`
3. `with R` -> `mit R`

## Lesson 4 - Auf dem Amt

DW focus: formal address, numbers above 100, and detailed personal information.  
DW ফোকাস: formal address, 100-এর উপরের সংখ্যা, আর detailed personal information।

Scene cue: At the police station, Jürgen Brunner speaks formally with Nico and asks for his details.  
সিন ইঙ্গিত: পুলিশ স্টেশনে ইউর্গেন ব্রুনার নিকোর সাথে formal ভাবে কথা বলে এবং তার details জিজ্ঞেস করে।
...
1. `How can I help you?` -> `Wie kann ich Ihnen helfen?`
2. `What is your date of birth?` -> `Wie ist Ihr Geburtsdatum?`
3. `Do you have an address?` -> `Haben Sie eine Adresse?`
...
- `Wie ist deine Telefonnummer?` -> `Meine Nummer ist ...`
- `Wo wohnst du?` -> `Ich wohne in ...`
- `Wie ist Ihr Geburtsdatum?` -> `Mein Geburtsdatum ist ...`
- `Haben Sie eine Adresse?` -> `Ja.` / `Nein.`
...
2. Say `31`, `38`, `83`, `136`, and `144` aloud.
3. Say your age: `Ich bin ... Jahre alt.`
4. Say your phone number digit by digit.
5. Do the short office role-play once formal, once informal.