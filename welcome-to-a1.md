...
1. Formal `How are you?` -> `Wie geht es Ihnen?`
2. Informal `And you?` -> `Und dir?`
3. `Danke, gut!` -> `ভালো, ধন্যবাদ!`

## Lesson 2 - Kein Problem!

DW focus: catching useful short words and phrases inside fast everyday speech.  
...
2. `Again!` -> `Noch mal!`
3. `To the center, please.` -> `Ins Zentrum, bitte.`

## Lesson 3 - Tschüss!

DW focus: saying goodbye in formal and informal ways and handling a short conversation.  
...
দ্রুত নোট: `Tschüss` আর `Mach's gut` casual। `Auf Wiedersehen` formal এবং বেশি safe।

Mini drill:

1. Formal goodbye -> `Auf Wiedersehen!`
2. `Take care!` -> `Mach's gut!`
3. `Do you need help?` -> `Brauchst du Hilfe?`
...
|---|---|---|
| How are you? formal | আপনি কেমন আছেন? | Wie geht es Ihnen? |
