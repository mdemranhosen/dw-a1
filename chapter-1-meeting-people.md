...
দ্রুত নোট: `Ich heiße ...` এই লেসনের মূল name pattern।

Mini drill:

1. `My name is Hasan.` -> `Ich heiße Hasan.`
2. `What's your name?` -> `Wie heißt du?`
3. `And what's your name?` -> `Und wie heißt du?`
...
1. `I am Rafi.` -> `Ich bin Rafi.`
2. `This is Sara.` -> `Das ist Sara.`
3. `This is Omar.` -> `Das ist Omar.`
...
1. `Where are you from?` -> `Woher kommst du?`
2. `I come from Bangladesh.` -> `Ich komme aus Bangladesch.`
3. `I live in Dhaka.` -> `Ich wohne in Dhaka.`
...
1. Say your name: `Ich heiße ...`
2. Introduce yourself: `Ich bin ...`
3. Say where you are from: `Ich komme aus ...`
4. Say where you live: `Ich wohne in ...`
5. Introduce a friend: `Das ist ...`
